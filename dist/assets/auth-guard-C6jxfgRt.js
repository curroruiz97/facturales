const h=["/signin.html","/signup.html","/verify-email.html","/confirm-email.html","/index-2.html","/404.html","/coming-soon.html","/subscribe.html","/billing/success.html","/billing/cancel.html"];function i(){const e=window.location.pathname;return h.some(t=>e.endsWith(t))}function a(){const e=window.location.pathname+window.location.search;sessionStorage.setItem("intended_url",e)}function m(){const e=sessionStorage.getItem("intended_url");sessionStorage.removeItem("intended_url"),window.location.href=e||"/index.html"}async function s(){try{return window.supabaseClient||(console.warn("Esperando inicialización de Supabase..."),await new Promise(t=>setTimeout(t,500))),window.supabaseAuthReady&&(console.log("⏳ Esperando a que Supabase auth esté listo..."),await window.supabaseAuthReady,console.log("✅ Supabase auth listo")),await window.checkAuth()?(console.log("✅ Usuario autenticado, acceso permitido"),!0):(console.log("⚠️ Usuario no autenticado, redirigiendo al login..."),a(),window.location.href="/signin.html",!1)}catch(e){return console.error("Error en auth guard:",e),window.location.href="/signin.html",!1}}async function c(){if(i()){console.log("📄 Página pública, no requiere autenticación");return}f(),await s()&&g()}function f(){if(!document.getElementById("auth-loading")){const e=document.createElement("div");e.id="auth-loading",e.style.cssText=`
      position: fixed;
      top: 0;
      left: 0;
      width: 100%;
