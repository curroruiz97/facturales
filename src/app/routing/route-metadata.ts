...
const ROUTE_METADATA: RouteMeta[] = [
  ...
  },
  {
    ...
    requiresAuth: true,
    requiresSubscription: true,
    breadcrumbs: ["Facturas", "Recibidas"],
    showGlobalSearch: true,
    shellVariant: "react-app",
  },
  {
...
const LEGACY_ALIASES: Record<string, string> = {
  ...
  "/invoices/facturas-recibidas.html": "/facturas/recibidas",
...
export const SHELL_NAVIGATION: NavigationItem[] = [
  { id: "dashboard", label: "Panel de control", href: "/dashboard", section: "menu" },
  {
    ...
    children: [
      ...
      { id: "facturas-recibidas", label: "Facturas recibidas", href: "/facturas/recibidas" },
